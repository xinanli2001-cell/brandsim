...
export default function NewChallengePage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      router.push(`/teacher/monitor/${data.challenge.id}`);
    } catch {
    ...
    <div className="flex flex-col gap-stack-lg pb-24 md:pb-0">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="font-body-main text-body-main text-on-surface-variant mt-2 max-w-2xl">
            Configure the parameters for a new marketing simulation scenario.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-stack-lg">
        ...
        <div className="md:col-span-4 space-y-stack-lg">
          <section className="bg-white rounded-2xl border border-[#E2E8F0] ambient-shadow p-stack-md">
            ...
            <div className="space-y-5">
                ...
                <div className="flex gap-2">
                  {(["easy", "normal", "hard"] as Difficulty[]).map((d) => (
                    <button
                      ...
                      className={`flex-1 py-2 rounded-lg border font-title-md text-[14px] capitalize ${
                        difficulty === d
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    className="w-full rounded-xl border-outline-variant focus:border-primary focus:ring-primary/20 bg-surface-bg py-3 pl-12 pr-4 transition-colors font-label-mono text-on-background"
              ...
              <div>
                ...
                <input
                  ...
                  min={1}
                  max={10}
                  className="w-full rounded-xl border-outline-variant focus:border-primary focus:ring-primary/20 bg-surface-bg py-3 px-4 transition-colors font-label-mono text-on-background"
                  value={totalRounds}
            ...
            <div className="space-y-4">
              {ACTION_TOGGLES.map((toggle) => (
                ...
                >
                  ...
                  <input
                    type="checkbox"
                    checked={actions.includes(toggle.key)}
                    onChange={() => toggleAction(toggle.key)}
              ...
              <label className="flex items-center justify-between cursor-pointer group pt-4 border-t border-outline-variant/30">
                <span className="font-title-md text-[14px] text-on-background">
                  Enable Leaderboard
                </span>
                <div
